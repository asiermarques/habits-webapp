...
describe('HabitForm', () => {
  it('hides the positive toggle for workout type', () => {
    render(<HabitForm submitLabel="Add" onSubmit={vi.fn()} initial={{
      id: 1, name: 'Run', type: 'workout', positive: true, color: '#000', createdAt: '',
    }} />);
  ...
  it('shows the positive toggle for custom type', () => {
    render(<HabitForm submitLabel="Add" onSubmit={vi.fn()} initial={{
      id: 1, name: 'Reading', type: 'custom', positive: true, color: '#000', createdAt: '',
    }} />);
  ...
  it('locks the type selector when typeLocked is true', () => {
    render(
      <HabitForm
        ...
        onSubmit={vi.fn()}
        typeLocked
        initial={{ id: 1, name: 'Run', type: 'workout', positive: true, color: '#000', createdAt: '' }}
      />,
    );
